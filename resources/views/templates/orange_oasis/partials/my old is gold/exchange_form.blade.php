...
<div class="custom-widget mb-0 pt-5 ps-5 pe-5">
    <div class="custom-widget mb-4">
        <h4 class="text-center" style="display: flex; align-items: center; justify-content: center;">
            <img src="https://i.imgur.com/6X9WgHX.gif" alt="Latest Exchanges" style="max-width: 3em; max-height: 3em; margin-top: -0.5em; margin-right: 1em;">
            <span style="font-weight: bold; font-size: 1.2em; white-space: nowrap;">@lang('EXCHANGE')</span>
            <img src="https://i.imgur.com/6X9WgHX.gif" alt="Latest Exchanges" style="max-width: 3em; max-height: 3em; margin-top: -0.5em; margin-left: 1em;">
        </h4>
    </div>
</div>
         ...
         <div class="col-md-6 mx-auto">
          <div class="">
            ...
            <div class="input-group">
                <input type="text" name="sending_amount" value="" id="you_send" class="center-control" aria-label="Text input with dropdown button" placeholder="@lang('You Send')" onkeyup="youSend(event)">
                ...
                <ul class="dropdown-menu dropdown-menu-end" name="sending_currency" style="max-height: 200px; overflow-y: auto; width: 200px;" >
                 ...
                 <li>
                                    <a href="javascript:void(0);" class="dropdown-item" onclick="selectSendGateway('{{ $sellCurrency->name }}', '{{ getImage(getFilePath('currency') . '/' . @$sellCurrency->image, getFileSize('currency')) }}', {{ $sellCurrency->id }})">
  ...
  #you_send {
    ...
    border: 6px solid #ced4da; /* Add border style for the input */
  }
  #you_send {
    width: 200px; /* Adjust the width as needed */
    border-radius: 5px; /* Adjust the border-radius to change the shape */
    border: 5px solid #8a2be2; /* Add border style */
  }

  /* Style for the placeholder text */
  #you_send::placeholder {
    font-size: 14px; /* Adjust the font-size as needed */
    color: #6c757d; /* Adjust the color of the placeholder text */
    border: 1px solid #8a2be2; /* Add border style for the placeholder */
    border-radius: 5px; /* Adjust the border-radius for the placeholder */
    padding: 5px; /* Add padding for the placeholder */
  }
    #you_get {
    width: 200px; /* Adjust the width as needed */
    border-radius: 5px; /* Adjust the border-radius to change the shape */
...
<div class="col-md-6 mx-auto">
    <div class="">
        ...
        <div class="input-group">
            <input type="text" name="reciving_amount" id="you_get" value="" class="center-control" aria-label="Text input with dropdown button" onkeyup="youGet(event)" placeholder="@lang('You Get')">
