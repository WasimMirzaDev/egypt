    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('exchange-rates.*') }} ">
                    <a href="{{ route('exchange-rates.create') }}" class="nav-link">
                        <i class="las la-sync menu-icon"></i>
                ...
                <li class="sidebar-menu-item {{ menuActive('Menage Reviews.*') }} ">
                    <a href="{{ route('show.reviews') }}" class="nav-link">
                        <i class="las la-star menu-icon"></i>
                        <span class="menu-title">@lang('Menage Review ')</span>
                    </a>
                </li>
