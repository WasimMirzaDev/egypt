            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between flex-wrap flex-column">
                            <h5>{{ showAmount($exchange->sending_amount) }} {{ __(@$exchange->sendCurrency->cur_sym) }}</h5>
                            <small class="text-muted"> @lang('Amount')</small>
                        </li>
                        <li class="list-group-item d-flex justify-content-between flex-wrap flex-column">
                            <h5>
                                {{ showAmount(@$exchange->charge->sending_charge->percent_amount) }} {{ __(@$exchange->sendCurrency->cur_sym) }}
                                <small class="text--small">({{ getAmount(@$exchange->charge->sending_charge->percent_charge) }}%)</small>
                            </h5>
                            <small class="text-muted"> @lang('Percent Charge')</small>
                        </li>
                        <li class="list-group-item d-flex justify-content-between flex-wrap flex-column">
                            <h5>{{ showAmount(@$exchange->charge->sending_charge->fixed_charge) }} {{ __(@$exchange->sendCurrency->cur_sym) }}</h5>
                            <small class="text-muted"> @lang('Fixed Charge')</small>
                        </li>
                        <li class="list-group-item d-flex justify-content-between flex-wrap flex-column">
                            <h5 class="text--danger">{{ showAmount($exchange->sending_charge) }} {{ __(@$exchange->sendCurrency->cur_sym) }}</h5>
                            <small class="text-muted"> @lang('Total Charge')</small>
                        </li>
                        <li class="list-group-item d-flex justify-content-between flex-wrap flex-column">
                            <h5>{{ showAmount($exchange->sending_charge + $exchange->sending_amount) }} {{ __(@$exchange->sendCurrency->cur_sym) }}</h5>
                            <small class="text-muted"> @lang('Total Admount Sent By User')</small>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between flex-wrap flex-column">
                            <h5>{{ showAmount($exchange->receiving_amount) }} {{ __(@$exchange->receivedCurrency->cur_sym) }}</h5>
                            <small class="text-muted"> @lang('Amount')</small>
                        </li>
                        <li class="list-group-item d-flex justify-content-between flex-wrap flex-column">
                            <h5>
                                {{ showAmount(@$exchange->charge->receiving_charge->percent_amount) }} {{ __(@$exchange->receivedCurrency->cur_sym) }}
                                <small class="text--small">({{ getAmount(@$exchange->charge->receiving_charge->percent_charge) }}%)</small>
                            </h5>
                            <small class="text-muted"> @lang('Percent Charge')</small>
                        </li>
                        <li class="list-group-item d-flex justify-content-between flex-wrap flex-column">
                            <h5>{{ showAmount(@$exchange->charge->receiving_charge->fixed_charge) }} {{ __(@$exchange->receivedCurrency->cur_sym) }}</h5>
                            <small class="text-muted"> @lang('Fixed Charge')</small>
                        </li>
                        <li class="list-group-item d-flex justify-content-between flex-wrap flex-column">
                            <h5 class="text--danger">{{ showAmount($exchange->receiving_charge) }} {{ __(@$exchange->receivedCurrency->cur_sym) }}</h5>
                            <small class="text-muted"> @lang('Total Charge')</small>
                        </li>
                        <li class="list-group-item d-flex justify-content-between flex-wrap flex-column">
                            <h5>{{ showAmount($exchange->receiving_amount - $exchange->receiving_charge) }} {{ __(@$exchange->receivedCurrency->cur_sym) }}</h5>
                ...
                <div class="card-body">
                    ...
                    @if ($exchange->status == Status::EXCHANGE_APPROVED)
                        <div class="form-group alert alert-success p-3">
                            <span class="fw-bold text-dark">@lang('This exchange is paid succesfully')</span>
                        </div>
                    @endif
                </div>
            </div>
...
@push('breadcrumb-plugins')
    ...
    <a href="{{ route('admin.exchange.download', $exchange->id) }}" class="btn btn-sm btn-outline--dark">
        <i class="la la-download"></i>@lang('Download')</a>
@endpush
